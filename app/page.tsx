...
const page = () => {
  return (
    <div className="flex flex-col items-center justify-center 2xl:h-screen xl:h-screen  h-full text-white">
      <h1 className="text-5xl font-bold mb-20">ChatGPT</h1>

      <div className="flex xl:flex-row 2xl:flex-row flex-col space-x-2 text-center">
        <div>
